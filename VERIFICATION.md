...
- `frac_mul_div_mono`
- `inputEff_cast_le_exact`
- `dyOutX_cast_le_dy_of_swap`
- `dxOutY_cast_le_dy_of_swap`
- `sim_swapXforY`
- `sim_swapYforX`
- `sim_addLiquidity`
...
- CI checks that the `VERIFICATION.md` theorem section remains generator-synchronized via `scripts/theorem_inventory.py --check-verification`.
- CI validates theorem inventory references in `VERIFICATION.md` against Lean declarations via `scripts/validate_theorem_inventory.py` (complete mode).
