...
| Recipient-fee output path can preserve reserve-sync while recipient output diverges | `RecipientFeePush`, `recipientFeePush_exactPushDelta`, `recipientFeePush_receiver_not_exact`, `reserveSync_and_outputDivergence_by_recipientFeePushY` | `CPAMM.Tokenized.Adversarial.t.sol::test_outputFeeOnPoolTransfer_breaksObservedSwapXforYOutput`, `CPAMM.Tokenized.Adversarial.t.sol::test_outputFeeOnPoolTransfer_breaksObservedSwapYforXOutput` | Unsupported (not rejected) |
